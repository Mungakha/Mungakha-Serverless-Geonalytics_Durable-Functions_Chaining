...
def main(num: int) -> int:
    logging.info(f"Triggered Function Number: {num}")
    ...
    try:
        gis.content.search("Denffindcentroids")[0].delete()
        gis.content.search("DenfHealthLyrPolygonToPoint")[0].delete()
    except:
        pass
    ...
    try:
        g=dissolve_boundaries(l, dissolve_fields,output_name='FeatureName3')#Dissolve the polygon feature service on these fields
    ...
    try:
        pp= find_centroids(c, output_name="CentroidFeatureName")
